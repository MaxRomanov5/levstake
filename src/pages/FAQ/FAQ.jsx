...
const FAQ = () => {
  ...
  const desk = useMediaQuery(theme.breakpoints.up('lg'))
    return (
      ...
      <Typography sx={{marginBottom:'24px',textAlign:'center',...(desk&&{fontSize:'64px',lineHeight:'70px'})}} color='primary.main' variant="h2">Frequently asked questions</Typography> 
              <Typography sx={{marginBottom:'80px',textAlign:'center'}} color='primary.main' variant="subtitle1" >Find your answers here.</Typography>
              <Stack sx={{padding:'16px',margin:'0 auto',marginBottom:'80px',maxWidth:'772px'}}>
