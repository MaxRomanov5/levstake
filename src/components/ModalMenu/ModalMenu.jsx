...
<nav style={{display:'flex',flexDirection:'column',gap:'40px'}}>
          ...
          <NavLink onClick={handleClick} to="/home"><Typography variant='subtitle1' className={styled.current} sx={{fontSize:'16px',fontWeight:'500',color:'primary.main',lineHeight:'16px',padding:'8px'}}>Home<div className={styled.line}></div></Typography></NavLink>
